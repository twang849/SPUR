...
export default function FoxTherapist() {
  ...
  function botReply(userText: string) {
    ...
    if (/hello|hi|hey/.test(lower)) {
      appendMessage("Greetings. What puzzle are we solving today?", "bot");
    } else if (/stuck|confused|lost/.test(lower)) {
      appendMessage("Let's look at this from a different angle. There's always a way.", "bot");
    } else if (/thank/.test(lower)) {
      appendMessage("You're welcome. Stay sharp.", "bot");
    } else {
      appendMessage("Interesting. Tell me more about your strategy.", "bot");
    }
  }
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <div className="animal-emoji-large" aria-label="Fox emoji">
          🦊
        </div>

...
export default function CatTherapist() {
  ...
  function botReply(userText: string) {
    ...
    if (/hello|hi|hey/.test(lower)) {
      appendMessage("What's up? No need to be formal.", "bot");
    } else if (/anxious|stressed|worried/.test(lower)) {
      appendMessage("Just relax. It's not that serious. Let's talk it out.", "bot");
    } else if (/thank/.test(lower)) {
      appendMessage("No problem. Glad I could help.", "bot");
    } else {
      appendMessage("I'm listening. Take your time.", "bot");
    }
  }
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <div className="animal-emoji-large" aria-label="Cat emoji">
          🐱
        </div>
